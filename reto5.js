// const giftsCities = [12, 3, 11, 5, 7, 49,20];
// const maxGifts = 20;
// const maxCities = 3;
...
//             // console.log("hola");
//             arrayPush.push(gift)
//             // console.log('%creto5.js line:17 arrayPush', 'color: #007acc;', arrayPush);

//             const suma = arrayPush.reduce((a, b) => a + b);
//             // console.log('%creto5.js line:22 suma', 'color: #007acc;', suma);
...
//     // console.log('%creto5.js line:29 giftToDeliver', 'color: #007acc;', giftToDeliver);
